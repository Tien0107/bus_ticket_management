...
export default function useChatSocket({
    ...
    useEffect(() => {
        ...
        const socket = io(SOCKET_URL, {
            transports: ["websocket", "polling"], // Cho phép fallback polling (rất quan trọng)
        ...
        // Expose main chat socket globally so Call system can use it (tránh tạo socket riêng)
