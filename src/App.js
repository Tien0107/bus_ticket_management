      ...
      <CallProvider>
        <BrowserRouter>
          <Routes>
            ...
            <Route
              path="/company-signup"
              element={<Navigate to="/register?type=company" replace />}
            />
            ...
            <Route element={<MainLayout />}>
              ...
              <Route
                ...
                element={<Navigate to="/profile/payment-methods" replace />}
              />
            </Route>
            ...
            <Route element={<DashboardLayout />}>
              ...
              <Route
                path="/operator/schedules/:scheduleId/stopping-points"
            ...
            <Route
              ...
              element={
                <div className="flex h-screen flex-col items-center justify-center">
                  ...
                  <p className="mb-6 text-xl font-medium text-gray-600">Không tìm thấy trang</p>
                  <a
                    href="/"
